      ...
      <div className="lg:pl-[200px]">
        <div className="mx-auto max-w-[1200px] px-4 py-6 md:px-6 md:py-10">
          <div className="overflow-hidden rounded-3xl border border-[#27272a] bg-black shadow-[0_0_80px_rgba(20,184,166,0.04)]">
            ...
            {/* ── FOOTER ── */}
            <Cell border={false} className="bg-[#0a0a0a]">
              <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
                ...
                <nav className="flex flex-wrap gap-6">
                  {["Product", "How it works", "Compliance", "Contact"].map((l) => (
                    <a key={l} href={`#${l.toLowerCase().replace(/ /g, "-")}`} className="text-sm text-[#52525b] hover:text-[#14B8A6] transition-colors">
                      {l}
                    </a>
                  ))}
                </nav>
              </div>
              <div className="mt-10 flex flex-col gap-2 border-t border-[#27272a] pt-8 sm:flex-row sm:justify-between">
                <p className="font-mono text-[11px] text-[#3f3f46]">© {new Date().getFullYear()} AITEL</p>
                <a href="mailto:hello@aitel.in" className="font-mono text-[11px] text-[#52525b] hover:text-[#14B8A6] transition-colors">
                  HELLO@AITEL.IN
                </a>
              </div>
            </Cell>
